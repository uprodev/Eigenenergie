					...
					<div class="content-flex d-flex justify-content-between flex-wrap">
						...
						<?php if (($is_default || $is_selection) && $terms): ?>
							<form class="select-block" id="filter_by_term">
								...
								<input type="hidden" name="wraper_class" value="content d-flex justify-content-between flex-wrap p-0">
					...
					<div class="row" id="response_posts">
						<div class="content d-flex justify-content-between flex-wrap p-0">
							...
							<?php while ($wp_query->have_posts()): $wp_query->the_post(); ?>
								...
								<div class="item">
									<?php get_template_part('parts/content', $template, ['link' => get_permalink(), 'thumbnail' => $thumbnail, 'subtitle' => __(mb_strtoupper(get_post_type())), 'title' => get_the_title()]) ?>
								</div>
